...
char CurveType[10] = "A21-SNAHYP";
char CurveTypeDesc[80] = "SNAILSHELL-HYPOTROCOID ALGO=21 SKIP STEP2 RUN-STEP1 RUN-ADJFR FRATECMD=40";
...
*/ // END BYPASS STEP 2
      ...
      if (line_count_limit > 50000) {
          ...
          printf (" RUN ERROR .... RECURSIVE NON STOP (e.g. u_next = 0.0000000 \n");
          printf (" More than 50,000 lines generated \n");
          printf (" Execute exit(1) at line 1314 in main(). \n");
